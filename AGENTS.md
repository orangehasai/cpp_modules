## 概要
本プロジェクトは42のC++を通してOOPを学ぶ一連の課題の一環です。課題は"cpp_module01"から"cpp_module09"まで存在し、各moduleごとにディレクトリを作成します。

## あなたへの指示
課題内容が書かれているcpp_module*/docs/の.pdfを読み、課題内容に沿ってC++学習用のコードを初学者向けに作成してもらいます。
コードはcpp_module*/sample/ex0*/に作成してください。またその課題で必要な知識、概念、コード記法、**言語特性/仕様**、注意点などをまとめた解説読み物をcpp_module*/sample/lecture.mdに作成してください。また、必要に応じてコードの解説をコメントでコード内に記載しても構いません。

また全ての課題においていかに記載するルールを遵守する必要があります。
