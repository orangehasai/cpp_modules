...
DiamondTrap::DiamondTrap()
	: ClapTrap("diamond-anonymous_clap_name"), ScavTrap("diamond-anonymous"),
	  FragTrap("diamond-anonymous"), _name("diamond-anonymous")
{
	_hitPoints = 100;
	_energyPoints = 50;
	_attackDamage = 30;
...
{
	std::cout << "[DiamondTrap status] name=" << _name
		<< ", clap_name=" << ClapTrap::_name << ", hp=" << _hitPoints
