...
int main(void)
{
	...
	printSection("Abstract Animal through polymorphic pointers");
	i = 0;
	while (i < animalCount)
	{
		if (i < animalCount / 2)
	...
	printSection("Animal can no longer be instantiated");
	std::cout << "Try uncommenting 'Animal meta;' and the compilation will fail."
		<< std::endl;
